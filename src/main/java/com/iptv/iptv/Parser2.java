    ...
    public void parser() {
        ...
        for(i=0;i<line.size();i++) {
            ...
            if(line.get(i).indexOf("#EXTINF:-1") >-1) {
                ...
                System.out.println("tvg-name:" +tmp[1]);
                if(tmp[3].length() >0) {
                	channelName.add(tmp[1]);
                }
                
                System.out.println("group-title:"+tmp[5]);
                if(tmp[5].length() >0) {
                	groupName.add(tmp[5]);
                }
                
                System.out.println("tvg-logo:" +tmp[7]);
                if(tmp[7].length() >0) {
                	pictureLink.add(tmp[7]);
                }
                ...
                i++;
                link.add(line.get(i));
                System.out.println("link:" +line.get(i));
            }
